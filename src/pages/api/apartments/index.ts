...
export const POST: APIRoute = async (context) => {
  ...
  try {
    ...
    if (!limits.can_add_apartment) {
      return new Response(JSON.stringify({ error: 'PLAN_LIMIT', message: 'Free plan allows 1 apartment. Upgrade to Pro for unlimited.' }), { status: 403 })
    }
